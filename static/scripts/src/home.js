...
(function() {
  $(document).on('ready', function() {
    var authorfield, countView, gcfield, hpAuthorSearch, hpCitySearch, hpSuggestAuthors, recentPlacesView, updateMapLinksWithLocation, updateMapLinksWithUserLocation;
    ...
    updateMapLinksWithLocation = function(location) {
      var lat, lng;
    ...
    updateMapLinksWithUserLocation = function() {
      if (navigator.geolocation) {
        return navigator.geolocation.getCurrentPosition(function(position) {
          ...
          return updateMapLinksWithLocation(userLocation);
        });
      }
    };
