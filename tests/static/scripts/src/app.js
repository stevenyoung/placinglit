...
(function() {
    ...
    HomepagemapView.prototype.initialize = function() {
      ...
      return places.fetch({
        error: function(model, response) {
          return console.log('location fetch error - home page map', response);
        },
  ...
  PlacingLit.Views.MapCanvasView = (function(_super) {
    ...
    MapCanvasView.prototype.mapWithMarkers = function() {
      var mapcenter, usacenter, usacenterCoords, _ref7,
        _this = this;

      if ((_ref7 = this.gmap) == null) {
        this.gmap = this.googlemap('map_canvas');
      }
      console.log('map markers', this.collection);
    ...
    MapCanvasView.prototype.handleInputAttributes = function() {
      var dealWithIEInputs, field, fields, _i, _len, _results;

      fields = $('#iwcontainer input');
      dealWithIEInputs = function(inputElement) {
        var _this = this;

        inputElement.value = inputElement['placeholder'];
        return $(inputElement).on('focus', function() {
          return _this.value = '';
        });
      };
      _results = [];
      for (_i = 0, _len = fields.length; _i < _len; _i++) {
        field = fields[_i];
        _results.push(dealWithIEInputs(field));
      }
      return _results;
    };
